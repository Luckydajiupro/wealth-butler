...
if __name__ == "__main__":
    ...
    mock_results = [
        {
            "entity": {
                "text": "货币基金是一种低风险的现金管理工具，主要投资于短期货币市场工具，如国债、央行票据、商业票据等。",
                "metadata": json.dumps({
        ...
        {
            "entity": {
                "text": "当前货币基金7日年化收益率约2.5%-3.0%，万份收益在0.7元左右。",
                "metadata": json.dumps({
                    "product_name": "天天利货币基金",
                    "chunk_type": "收益信息",
                    "product_id": "P001"
    ...
    print("=== 带引用格式 ===")
    print(format_search_results_with_citation(mock_results, "product"))

    print("\n=== 简化格式 ===")
    print(format_search_results_simple(mock_results, "product"))

    print("\n=== JSON格式 ===")
    import json as json_lib
    print(json_lib.dumps(
        format_search_results_json(mock_results, "product"),
        ensure_ascii=False,
        indent=2
    ))
